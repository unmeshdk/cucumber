...
public class GitRegistrationTest {
	...
	public void testForRegistrationSuccess() {
		registrationPage.setUsername("mytest123456udk");
		registrationPage.setPassword("mytest123456");
		registrationPage.setEmail("mytest123456@gmail.com");
		registrationPage.clickSubmitButton();
		//String message1 = 
		//String message2 = driver.findElement(By.xpath("//p[@class='lead']")).getText();
		String actualErrorMessage = "@" + driver.findElement(By.xpath("//p[@class='lead']//strong")).getText(); 
		System.out.println("success Message :- " + actualErrorMessage);
		String expectedErrorMessage = "@mytest123456";
		Assert.assertEquals(expectedErrorMessage, actualErrorMessage);
	}
}
